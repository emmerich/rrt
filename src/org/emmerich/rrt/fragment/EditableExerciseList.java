...
public class EditableExerciseList extends ListFragment implements LoaderCallbacks<Cursor> {
	
	private int workoutId;
	private EditableExerciseListCursorAdapter adapter; 

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View view = super.onCreateView(inflater, container, savedInstanceState);
		adapter = new EditableExerciseListCursorAdapter(getActivity(), null, getFragmentManager());
	...
	private class EditableExerciseListCursorAdapter extends CursorAdapter {
		private LayoutInflater inflater;
		private FragmentManager fragmentManager;

		public EditableExerciseListCursorAdapter(Context context, Cursor cursor, FragmentManager fragmentManager) {
